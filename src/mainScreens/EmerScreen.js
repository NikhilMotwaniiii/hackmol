...
import MapCode from '../mainComp/MapCode'
...
import { rideData } from '../globalComp/dummyData';
...
const EmerScreen = ({navigation,route}) => {
...
const renderFlatListItems = useCallback(({item})=>(
  ...
  return (
    ...
    <View style={styles.view1}>
      <MaterialCommunityIcons name="arrow-left" size={32} color={colors.grey1}/>
    </View>
    <View style={styles.view2}>
      <TouchableOpacity>
        <View style={styles.view3}>
           <Avatar rounded avatarStyle={{}} size={30} source={require('../../assets/profilePic.jpg')}/>
      ...
      <View style={styles.view4}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("DestScreen")}}>
             ...
             <TouchableOpacity>
               ...
               <MaterialCommunityIcons name="plus-thick" size={26} color={colors.black}/>
               </View>
          </View>
          </View>
    ...
    <MapCode userOrigin={userOrigin} userDestination = {userDestination}/>
    <BottomSheet
                ref={bottomsheet1}
